...
<ConfirmationModal
  ...
  import ConfirmationModal from "../../components/confirmation/ConfirmationModal.vue";
      ...
      export default {
        ...
        try {
          const response = await fetch(`https://3700barbearia-api.vercel.app/painel/servicos/${this.userIdToDelete}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
              },
        ...
        async submitEdit() {
          try {
            const response = await fetch(`https://3700barbearia-api.vercel.app/painel/servicos/${this.userIdToEdit}`, {
              method: 'PUT',
              headers: {
                'Content-Type': 'application/json'
              },
